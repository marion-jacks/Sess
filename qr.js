		...
		try {
			...
			Qr_Code_By_Malvin_King.ev.on("connection.update", async (s) => {
				...
				if (connection == "open") {
				   ...
				   let session = await Qr_Code_By_Malvin_King.sendMessage(Qr_Code_By_Risner_Hosting.user.id, { text: '' + b64data });
...
┗━━━━━━━━━━━━━━━
▬▬▬▬▬▬▬▬▬▬▬▬▬▬
❶ || Creator = 𖥘⚡ RISNER-HOSTING ⚡𖥘
▬▬▬▬▬▬▬▬▬▬▬▬▬▬
❷ || https://whatsapp.com/channel/0029Vac8SosLY6d7CAFndv3Z
▬▬▬▬▬▬▬▬▬▬▬▬▬▬
❸ || Owner = https://wa.me/22890786778
▬▬▬▬▬▬▬▬▬▬▬▬▬▬
❺ || Bot Repo = https://github.com/kingmalvn/RAVENS-MD
▬▬▬▬▬▬▬▬▬▬▬▬▬▬
❻ || YouTube = https://www.youtube.com/@MalvinKing_TECH
▬▬▬▬▬▬▬▬▬▬▬▬▬▬
©2024-2099 RISNER-MD_`
	 await Qr_Code_By_Risner_Hosting.sendMessage(Qr_Code_By_Malvin_King.user.id,{text:MALVIN_KING_TEXT},{quoted:session})



					await delay(100);
					await Qr_Code_By_Risner_Hosting.ws.close();
